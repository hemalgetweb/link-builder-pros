 ...
 * @since 1.0.0
 */
class CB_Core_ne_bountry_linkBuilder extends Widget_Base
{
	...
	{
		return 'cb-ne_bountry_linkBuilder';
	}
	...
	{
		return __('CB NE Bountry Express LinkBuilder', 'cb-core');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			'service_1_title',
			[
				'label' => __('Service 1 Title', 'cb-core'),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __('', 'cb-core'),
				'label_block' => true,
		...
		$this->add_control(
			'service_2_title',
			[
				'label' => __('Service 2 Title', 'cb-core'),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __('', 'cb-core'),
				'label_block' => true,
				'placeholder' => __('', 'cb-core'),
		...
		$this->add_control(
			'service_3_title',
			[
				'label' => __('Service 3 Title', 'cb-core'),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __('', 'cb-core'),
				'label_block' => true,
				'placeholder' => __('', 'cb-core'),
...
Plugin::instance()->widgets_manager->register(new CB_Core_ne_bountry_linkBuilder());

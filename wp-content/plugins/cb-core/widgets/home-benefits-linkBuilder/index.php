 ...
 * @since 1.0.0
 */
class CB_Core_Benifits_LB extends Widget_Base
{
	...
	{
		return __('CB Home Benefits LinkBuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_Benifits_LB());

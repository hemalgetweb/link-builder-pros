 ...
 * @since 1.0.0
 */
class CB_Core_fbl_taghere_linkBuilder extends Widget_Base
{
	...
	{
		return 'cb-fbl-taghere-linkBuilder';
	}
	...
	{
		return __('CB FBL Tag Here LinkBuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_fbl_taghere_linkBuilder());

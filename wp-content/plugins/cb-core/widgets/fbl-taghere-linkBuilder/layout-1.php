        ...
        <div class="container">
            ...
            <div class="section-content text-center">
                <div class="sub-heading">
                    ...
                    <?php echo cb_core_kses_basic(!empty($settings['banner_title_part_1']) ?$settings['banner_title_part_1']:"About Our Foundation SEO Backlinks"); ?> <br class="d-none d-lg-block">
                        <span class="text-clr-primary">
                        <?php echo cb_core_kses_basic(!empty($settings['banner_title_part_2']) ?$settings['banner_title_part_2']:"Quality Standard"); ?>
                        </span>
                        <?php echo cb_core_kses_basic(!empty($settings['banner_title_part_3']) ?$settings['banner_title_part_3']:"or Not?"); ?>
                    </h1>

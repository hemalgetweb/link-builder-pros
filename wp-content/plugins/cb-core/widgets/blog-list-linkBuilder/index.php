 ...
 * @since 1.0.0
 */
class CB_Core_blog_list_linkBuilder extends Widget_Base
{
	...
	{
		return 'cb-blog-list-linkBuilder';
	}
	...
	{
		return __('CB Blog List LinkBuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_blog_list_linkBuilder());

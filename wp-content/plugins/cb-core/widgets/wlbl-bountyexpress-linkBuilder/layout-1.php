        ...
        <div class="container">
            ...
            <div class="section-content text-center">
                <div class="sub-heading">
                    ...
                    <?php echo cb_core_kses_basic(!empty($settings['banner_title_part_1']) ?$settings['banner_title_part_1']:"Why choose Us to"); ?>
                        <span class="text-clr-primary">
                        <?php echo cb_core_kses_basic(!empty($settings['banner_title_part_2']) ?$settings['banner_title_part_2']:"White Label Backlinks"); ?>
                        </span>
                        <br class="d-none d-lg-block">
                        <?php echo cb_core_kses_basic(!empty($settings['banner_title_part_3']) ?$settings['banner_title_part_3']:"for Your SEO Agency?"); ?>
                    </h1>

 ...
 * @since 1.0.0
 */
class CB_Core_wlbl_ourstrength_linkBuilder extends Widget_Base
{
	...
	{
		return 'cb-wlbl_ourstrength_linkBuilder';
	}
	...
	{
		return __('CB White level Our Strength LinkBuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_wlbl_ourstrength_linkBuilder());

 ...
 * @since 1.0.0
 */
class CB_Core_wa_linkbuilding_linkBuilder extends Widget_Base
{
	...
	{
		return 'cb-wa-linkbuilding-linkBuilder';
	}
	...
	{
		return __('CB WA Link Building LinkBuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_wa_linkbuilding_linkBuilder());

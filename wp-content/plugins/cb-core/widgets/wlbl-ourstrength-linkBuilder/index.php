 ...
 * @since 1.0.0
 */
class CB_Core_wlbl_bountyexpress_linkBuilder extends Widget_Base
{
	...
	{
		return 'cb-wlbl_bountyexpress_linkBuilder';
	}
	...
	{
		return __('CB White level Bounty Express LinkBuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_wlbl_bountyexpress_linkBuilder());

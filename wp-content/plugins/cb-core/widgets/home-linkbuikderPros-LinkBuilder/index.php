 ...
 * @since 1.0.0
 */
class CB_Core_LinkBuilderPros_Home extends Widget_Base
{
	...
	{
		return 'cb-linkbuilderpros-home';
	}
	...
	{
		return __('CB Home LinkBuilderPros Linkbuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_LinkBuilderPros_Home());

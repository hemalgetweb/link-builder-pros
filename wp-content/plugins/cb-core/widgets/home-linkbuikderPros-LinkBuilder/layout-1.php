            ...
            <div class="col-md-6">
                <div class="section-content">
                    <div class="sub-heading">
                        ...
                        <?php echo cb_core_kses_basic(!empty($settings['banner_title_part_1'])?$settings['banner_title_part_1']:"Why is link"); ?>
                            <span class="text-clr-primary">
                            <?php echo cb_core_kses_basic(!empty($settings['banner_title_part_2'])?$settings['banner_title_part_2']:"building"); ?>
                            </span>
                            <?php echo cb_core_kses_basic(!empty($settings['banner_title_part_3'])?$settings['banner_title_part_3']:"important?"); ?>
                        </h1>

                        <p class="fw-normal fs-6 text-clr-dark2 mb-3 wow fadeInDown" data-wow-duration="0.60s" data-wow-delay="200ms">
                        <?php echo cb_core_kses_basic(!empty($settings['banner_text_1'])?$settings['banner_text_1']:"Having quality backlinks from other websites is the #1 influencing Google ranking factor. You can have the fastest, most beautiful website in the World, but if nobody is linking to your website, then you'll struggle for search engine traffic."); ?>
                        </p>

                        <p class="fw-normal fs-6 text-clr-dark2 mb-3 wow fadeInDown" data-wow-duration="0.60s" data-wow-delay="200ms">
                        <?php echo cb_core_kses_basic(!empty($settings['banner_text_2'])?$settings['banner_text_2']:"Our link building services help manage that entire process with a focus on high quality link building that's been fine tuned over many years."); ?>
                        </p>

                        <p class="fw-normal fs-6 text-clr-dark2 mb-5 wow fadeInDown" data-wow-duration="0.60s" data-wow-delay="200ms">
                        <?php echo cb_core_kses_basic(!empty($settings['banner_text_3'])?$settings['banner_text_3']:"We only build high-quality backlinks from trustworthy and authoritative websites that are relevant to your industry. We never use black hat methodologies, and prefer a manual approach to backlink building which focuses on real relationships."); ?>
                        </p>

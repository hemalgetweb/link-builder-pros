 ...
 * @since 1.0.0
 */
class CB_Core_Howitworks extends Widget_Base
{
	...
	{
		return __('CB Home How It Works LinkBuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_Howitworks());

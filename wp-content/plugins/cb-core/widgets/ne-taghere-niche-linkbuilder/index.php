 ...
 * @since 1.0.0
 */
class CB_Core_ne_taghere_niche_linkbuilder extends Widget_Base
{
	...
	{
		return 'cb-ne_taghere_niche_linkbuilder';
	}
	...
	{
		return __('CB NE Tag Here Niche Linkbuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_ne_taghere_niche_linkbuilder());

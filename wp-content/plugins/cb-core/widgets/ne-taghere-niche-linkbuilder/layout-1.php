             ...
             <div class="col-lg-6">
                 <div class="section-content">
                     <div class="sub-heading">
                         ...
                         <?php echo cb_core_kses_basic(!empty($settings['banner_title_part_1'])?$settings['banner_title_part_1']:"What is"); ?>
                             <span class="text-clr-primary">
                             <?php echo cb_core_kses_basic(!empty($settings['banner_title_part_2'])?$settings['banner_title_part_2']:"Niche Edits"); ?>
                             </span>
                         ...
                         <?php echo cb_core_kses_basic(!empty($settings['banner_text_1'])?$settings['banner_text_1']:"Niche edit service Philippines is a popular query for Western companies looking for affordable yet, relevant and high-quality niche edit solutions."); ?>
                         </p>

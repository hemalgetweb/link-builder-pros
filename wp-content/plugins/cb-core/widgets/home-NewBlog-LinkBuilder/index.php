 ...
 * @since 1.0.0
 */
class CB_Core_NewsBlog_Home extends Widget_Base
{
	...
	{
		return __('CB Home News Blog Linkbuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_NewsBlog_Home());

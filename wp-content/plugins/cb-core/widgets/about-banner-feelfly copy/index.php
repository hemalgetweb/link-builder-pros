 ...
 * @since 1.0.0
 */
class CB_Core_AboutBanner_Simple extends Widget_Base
{
	...
	{
		return __('CB About Banner LinkBuilder', 'cb-core');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'default' => __('Turns Your Idea into ', 'cb-core'),
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'default' => __('Deliverables', 'cb-core'),
				'placeholder' => __('Type your title here', 'cb-core'),
				'condition' => [
					'layout' => ['layout-1']
				]
...
Plugin::instance()->widgets_manager->register(new CB_Core_AboutBanner_Simple());

 ...
 * @since 1.0.0
 */
class CB_Core_wlbl_service_packages_linkBuildr extends Widget_Base
{
	...
	{
		return 'cb-CB_Core_wlbl_service_packages_linkBuildr';
	}
	...
	{
		return __('CB Wlbl Service Packages LinkBuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_wlbl_service_packages_linkBuildr());

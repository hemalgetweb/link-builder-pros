 ...
 * @since 1.0.0
 */
class CB_Core_ne_banner_feelfly extends Widget_Base
{
	...
	{
		return 'cb-CB_Core_ne_banner_feelfly';
	}
	...
	{
		return __('CB NE Banner Linkbuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_ne_banner_feelfly());

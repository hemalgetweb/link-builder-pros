 ...
 * @since 1.0.0
 */
class CB_Core_ClinetCounter_LB extends Widget_Base
{
	...
	{
		return __('CB About Client Counter LinkBuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_ClinetCounter_LB());

 ...
 * @since 1.0.0
 */
class CB_Core_MeetOurTeam_LB extends Widget_Base
{
	...
	{
		return __('CB About Meet Our Team LinkBuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_MeetOurTeam_LB());

 ...
 * @since 1.0.0
 */
class CB_Core_HIRINGEXPERT extends Widget_Base
{
	...
	{
		return __('CB Home Hiring Expert LinkBuilder', 'cb-core');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'default' => __('Hiring expert', 'cb-core'),
				'label_block' => true,
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'default' => __('Benefits of ', 'cb-core'),
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'default' => __('LinkBuilderPro', 'cb-core'),
				'placeholder' => __('Type your title here', 'cb-core'),
				'condition' => [
					'layout' => ['layout-1']
				]
		...
		$repeaterFeaturedIncluded->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __('Specialized Expertise', 'cb-core'),
				'label_block' => true,
				'condition' => [
					'field_condition' => ['style-1']
				],
		...
		$repeaterFeaturedIncluded->add_control(
			...
			[
				...
				'default' => __('Link building agencies are often staffed with experts who have extensive experience and knowledge in the field. They stay up-to-date with the latest best practices, techniques, and trends, and have a deep understanding of what works', 'cb-core'),
				'label_block' => true,
				'condition' => [
					'field_condition' => ['style-1']
				],
...
Plugin::instance()->widgets_manager->register(new CB_Core_HIRINGEXPERT());

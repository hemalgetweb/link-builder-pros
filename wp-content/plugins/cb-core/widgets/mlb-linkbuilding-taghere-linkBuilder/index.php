 ...
 * @since 1.0.0
 */
class CB_Core_mbl_linkbuilding_taghere_linkBuilder extends Widget_Base
{
	...
	{
		return 'cb-linkbuilding_taghere_linkBuilder';
	}
	...
	{
		return __('CB MLB Linkbuilding Taghere LinkBuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_mbl_linkbuilding_taghere_linkBuilder());

 ...
 * @since 1.0.0
 */
class CB_Core_fbl_linkbuilderpros_linkbulilder extends Widget_Base
{
	...
	{
		return 'cb-fbl-linkbuilderpros-linkbulilder';
	}
	...
	{
		return __('CB FBL Linkbuilder pros Linkbuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_fbl_linkbuilderpros_linkbulilder());

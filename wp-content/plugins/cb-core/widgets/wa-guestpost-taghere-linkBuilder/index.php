 ...
 * @since 1.0.0
 */
class CB_Core_wa_guestpost_taghere_linkBuilder extends Widget_Base
{
	...
	{
		return 'cb-wa-guestpost-taghere-linkBuilder';
	}
	...
	{
		return __('CB WA second Post Tag Here LinkBuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_wa_guestpost_taghere_linkBuilder());

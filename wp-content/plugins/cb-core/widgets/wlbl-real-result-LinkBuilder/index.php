 ...
 * @since 1.0.0
 */
class CB_Core_wlbl_real_result_LinkBuilder extends Widget_Base
{
	...
	{
		return 'cb-wlbl_real_result_LinkBuilder';
	}
	...
	{
		return __('CB Wlbl Real Result Linkbuilder', 'cb-core');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			'banner_text_2',
			[
				'label' => __('Banner Text 2', 'cb-core'),
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'default' => __('', 'cb-core'),
				'placeholder' => __('', 'cb-core'),
...
Plugin::instance()->widgets_manager->register(new CB_Core_wlbl_real_result_LinkBuilder());

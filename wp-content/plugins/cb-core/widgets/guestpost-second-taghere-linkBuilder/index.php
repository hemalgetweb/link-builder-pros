 ...
 * @since 1.0.0
 */
class CB_Core_GuestPostTagHere_LB2 extends Widget_Base
{
	...
	{
		return 'cb-guestposttaghere-home2';
	}
	...
	{
		return __('CB Guest second Post Tag Here LinkBuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_GuestPostTagHere_LB2());

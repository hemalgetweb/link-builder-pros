 ...
 * @since 1.0.0
 */
class CB_Core_bo_service_campaign_LinkBuilder extends Widget_Base
{
	...
	{
		return 'cb-bo_service_campaign_LinkBuilder';
	}
	...
	{
		return __('CB BO Service Campaign Linkbuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_bo_service_campaign_LinkBuilder());

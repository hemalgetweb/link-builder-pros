            ...
            <div class="col-md-6 mb-5 mb-lg-0">
                <div class="section-content">
                    <div class="sub-heading">
                        ...
                        <h1 class="fw-bold fs-36 text-clr-dark1 pb-2 mb-3 wow fadeInDown" data-wow-duration="0.5s" data-wow-delay="150ms" style="visibility: visible; animation-duration: 0.5s; animation-delay: 150ms; animation-name: fadeInDown;">
                        <?php echo cb_core_kses_basic(!empty($settings['banner_title_part_1'])?$settings['banner_title_part_1']:"Typically included in a blogger outreach"); ?>
                                <span class="text-clr-primary">
                                <?php echo cb_core_kses_basic(!empty($settings['banner_title_part_2'])?$settings['banner_title_part_2']:"service campaign"); ?>
                                </span>
                            </h1>
                ...
                <div class="d-inline-block mt-3 pt-3">
                    <a href="<?php echo cb_core_kses_basic(!empty($settings['button_link'])?$settings['button_link']:""); ?>" class="d-flex align-items-center gap-3 common-btn text-decoration-none fs-6 fw-bold bg-clr-primary text-white wow fadeInDown" data-wow-duration="1.30s" data-wow-delay="260ms" style="visibility: visible; animation-duration: 1.3s; animation-delay: 260ms; animation-name: fadeInDown;">
                        <span>
                            More Services
                        </span>

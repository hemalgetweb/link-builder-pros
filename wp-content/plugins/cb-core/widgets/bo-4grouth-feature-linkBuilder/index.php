 ...
 * @since 1.0.0
 */
class CB_Core_bo_4grouth_feature_linkBuilder extends Widget_Base
{
	...
	{
		return 'cb_CB_Core_bo_4grouth_feature_linkBuilder';
	}
	...
	{
		return __('CB BO 4 Grouth Feature LinkBuilder', 'cb-core');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			'banner_title_part_4',
			[
				'label' => __('Banner Title Part 4', 'cb-core'),
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'default' => __('', 'cb-core'),
				'placeholder' => __('Type your title here', 'cb-core'),
...
Plugin::instance()->widgets_manager->register(new CB_Core_bo_4grouth_feature_linkBuilder());

 ...
 * @since 1.0.0
 */
class CB_Core_bo_service_packages_linkBuilder extends Widget_Base
{
	...
	{
		return 'cb-CB_Core_bo_service_packages_linkBuilder';
	}
	...
	{
		return __('CB BO Service Packages LinkBuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_bo_service_packages_linkBuilder());

 ...
 * @since 1.0.0
 */
class CB_Core_fbl_golden_elements_linkBuilder extends Widget_Base
{
	...
	{
		return 'cb-fbl-golden-elements-linkBuilder';
	}
	...
	{
		return __('CB FBL Golden Element LinkBuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_fbl_golden_elements_linkBuilder());

 <!-- Golden Elements -->
 <section id="benefits" class="section-padding bg-white" style="background-image: url(<?php echo esc_url($settings['banner_background_image']['url']) ? esc_url($settings['banner_background_image']['url']): ''; ?>); background-repeat: no-repeat; background-size: cover; background-position: center;">
        <div class="container">
            ...
            <div class="section-content text-center">
                <div class="sub-heading">
                    ...
                    <?php echo cb_core_kses_basic(!empty($settings['banner_title_part_1']) ?$settings['banner_title_part_1']:"Foundation Backlinks"); ?>
                        <span class="text-clr-primary">
                        <?php echo cb_core_kses_basic(!empty($settings['banner_title_part_2']) ?$settings['banner_title_part_2']:"Quality Standards"); ?>
                        </span>
                    </h1>
            ...
            <div class="row golden-elements-card-wrapper">
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    <div class="golden-elements-card bg-white h-100 wow fadeInUp" data-wow-duration="0.55s" data-wow-delay="220ms">
                        <div class="card border-0">
                            ...
                            <div class="benefites-card-content mb-2">
                                ...
                                <?php echo cb_core_kses_basic(!empty($slide['service_title']) ?$slide['service_title']:"Links with Relevancy & Domain Authority"); ?>
                                </h5>
                                <p class="card-text fw-normal fs-6 text-clr-dark2">
                                <?php echo cb_core_kses_basic(!empty($slide['service_text']) ?$slide['service_text']:"Lorem Ipsum is simply dummy text of the printing and typesetting."); ?>
                                </p>
                            </div>
                        </div>
                    </div>

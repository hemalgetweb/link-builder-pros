 ...
 * @since 1.0.0
 */
class CB_Core_Brand_Home extends Widget_Base
{
	...
	{
		return __('CB Brand Home feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_Brand_Home());

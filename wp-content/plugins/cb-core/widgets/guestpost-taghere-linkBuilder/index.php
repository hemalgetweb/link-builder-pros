 ...
 * @since 1.0.0
 */
class CB_Core_GuestPostTagHere_LB extends Widget_Base
{
	...
	{
		return 'cb-guestposttaghere-home';
	}
	...
	{
		return __('CB Guest Post Tag Here LinkBuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_GuestPostTagHere_LB());

 ...
 * @since 1.0.0
 */
class CB_Core_Testimonial_Home extends Widget_Base
{
	...
	{
		return __('CB Home Testimonial Linkbuilder', 'cb-core');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'default' => __('What Our Link Building ', 'cb-core'),
		...
		$repeaterFeaturedIncluded->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __('Ralph Edwards', 'cb-core'),
				'label_block' => true,
				'condition' => [
					'field_condition' => ['style-1']
				],
		...
		$repeaterFeaturedIncluded->add_control(
			'service_sub_title',
			[
				'label' => __('Service Sub Title', 'cb-core'),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __('Co-Founder - Grow & Convert', 'cb-core'),
				'label_block' => true,
				'condition' => [
					'field_condition' => ['style-1']
				],
		...
		$repeaterFeaturedIncluded->add_control(
			...
			[
				...
				'default' => __('We have been working with them for 2 years now, link building for over 25 different clients. The quality of links is always amazing, communication is great.', 'cb-core'),
				'label_block' => true,
				'condition' => [
					'field_condition' => ['style-1']
				],
...
Plugin::instance()->widgets_manager->register(new CB_Core_Testimonial_Home());

 ...
 * @since 1.0.0
 */
class CB_Core_mlb_banner_linkbulilder extends Widget_Base
{
	...
	{
		return 'cb-CB_mlb_banner_linkbulilder';
	}
	...
	{
		return __('CB MLB Banner Linkbuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_mlb_banner_linkbulilder());

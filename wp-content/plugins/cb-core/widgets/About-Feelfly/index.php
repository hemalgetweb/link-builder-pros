 ...
 * @since 1.0.0
 */
class CB_Core_About_Feelfly extends Widget_Base
{
	...
	{
		return __('CB about-feature feelfly', 'cb-core');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'default' => __('About LinkBuilderPros', 'cb-core'),
				'label_block' => true,
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'default' => __('The link building ', 'cb-core'),
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'default' => __('that <br> drives insane rankings', 'cb-core'),
				'placeholder' => __('Type your title here', 'cb-core'),
				'condition' => [
					'layout' => ['layout-1']
				]
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'default' => __('Consectetur adipiscing elit, sed do eiusmod tempor quis laboris incididunt ut labore et dolore magna aliqua.', 'cb-core'),
...
Plugin::instance()->widgets_manager->register(new CB_Core_About_Feelfly());

 ...
 * @since 1.0.0
 */
class CB_Core_lc_bounty_express_linkBuilder extends Widget_Base
{
	...
	{
		return 'cb-lcb-bounty-express-linkBuilder';
	}
	...
	{
		return __('CB LCB Bounty Express LinkBuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_lc_bounty_express_linkBuilder());

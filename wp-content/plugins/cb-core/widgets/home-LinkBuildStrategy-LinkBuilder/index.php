 ...
 * @since 1.0.0
 */
class CB_Core_LinkBuildStrategy_Home extends Widget_Base
{
	...
	{
		return 'cb-linkbuildstrategy-home';
	}
	...
	{
		return __('CB Home Link Build Strategy Linkbuilder', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_LinkBuildStrategy_Home());

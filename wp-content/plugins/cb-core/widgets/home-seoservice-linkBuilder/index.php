 ...
 * @since 1.0.0
 */
class CB_Core_SEOSERVICE extends Widget_Base
{
	...
	{
		return __('CB Home Seo Service LinkBuilder', 'cb-core');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'default' => __('SEO services', 'cb-core'),
				'label_block' => true,
		...
		$repeaterFeaturedIncluded->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __('Relationship-Based Link Building', 'cb-core'),
				'label_block' => true,
				'condition' => [
					'field_condition' => ['style-1']
				],
		...
		$repeaterFeaturedIncluded->add_control(
			...
			[
				...
				'default' => __('This technique is where we develop relationship and connections with influential publishers in your space.', 'cb-core'),
				'label_block' => true,
				'condition' => [
					'field_condition' => ['style-1']
				],
...
Plugin::instance()->widgets_manager->register(new CB_Core_SEOSERVICE());

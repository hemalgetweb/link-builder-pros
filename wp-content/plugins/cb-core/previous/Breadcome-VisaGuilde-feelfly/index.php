 ...
 * @since 1.0.0
 */
class CB_Core_Breadcome_VisaGuide_FeelFly extends Widget_Base
{
	...
	{
		return 'cb-best-breadcome-visaguide-feelfly';
	}
	...
	{
		return __('CB VisaGuide Breadcome Feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_Breadcome_VisaGuide_FeelFly());

 ...
 * @since 1.0.0
 */
class CB_Core_Newsletter_FeelFly extends Widget_Base
{
	...
	{
		return 'cb-best-newsletter-feelfly';
	}
	...
	{
		return __('CB Newsletter Feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_Newsletter_FeelFly());

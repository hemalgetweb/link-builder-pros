 ...
 * @since 1.0.0
 */
class CB_Core_Blog_Breadcome_FeelFly extends Widget_Base
{
	...
	{
		return 'cb-blog-breadcome-feelfly';
	}
	...
	{
		return __('CB Blog Breadcome Feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_Blog_Breadcome_FeelFly());

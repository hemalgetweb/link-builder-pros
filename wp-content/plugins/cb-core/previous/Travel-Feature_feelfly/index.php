 ...
 * @since 1.0.0
 */
class CB_Core_Travel_Feature extends Widget_Base
{
	...
	{
		return 'cb-travel-feature-feelfly';
	}
	...
	{
		return __('CB Travel Feature Feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_Travel_Feature());

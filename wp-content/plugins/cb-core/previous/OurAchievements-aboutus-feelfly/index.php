 ...
 * @since 1.0.0
 */
class CB_Core_OurAchievements_AboutUS_FeelFly extends Widget_Base
{
	...
	{
		return 'cb-ourachievements-aboutus-feelfly';
	}
	...
	{
		return __('CB Our Achievements AboutUs Feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_OurAchievements_AboutUS_FeelFly());

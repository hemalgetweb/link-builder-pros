    ...
    <div class="container">
        <div class="row g-lg-4 g-md-3">
            ...
            <div class="col-xl-6 col-md-4">
                <div class="season-sale-box season-sale-box-2" data-background="<?php echo esc_url($settings['banner_imag_2']['url']) ? esc_url($settings['banner_imag_2']['url']): ''; ?>">
                    <div class="part-txt">

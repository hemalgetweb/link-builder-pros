 ...
 * @since 1.0.0
 */
class CB_Core_Tour_Package extends Widget_Base
{
	...
	{
		return __('CB Tour Package Feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_Tour_Package());

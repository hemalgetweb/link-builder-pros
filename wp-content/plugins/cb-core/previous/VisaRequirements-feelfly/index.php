 ...
 * @since 1.0.0
 */
class CB_Core_VisaRequirements_FeelFly extends Widget_Base
{
	...
	{
		return 'cb-visa-requirements-feelfly';
	}
	...
	{
		return __('CB VisaRequirements Feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_VisaRequirements_FeelFly());

 ...
 * @since 1.0.0
 */
class CB_Core_Breadcome_FeelFly extends Widget_Base
{
	...
	{
		return 'cb-best-breadcome-feelfly';
	}
	...
	{
		return __('CB ContactUs Breadcome Feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_Breadcome_FeelFly());

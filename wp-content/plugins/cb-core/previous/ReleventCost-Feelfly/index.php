 ...
 * @since 1.0.0
 */
class CB_Core_ReleventCost_FeelFly extends Widget_Base
{
	...
	{
		return 'cb-relevent-cost-feelfly';
	}
	...
	{
		return __('CB Relevent Cost Feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_ReleventCost_FeelFly());

 ...
 * @since 1.0.0
 */
class CB_Core_OurPolicy_FeelFly extends Widget_Base
{
	...
	{
		return __('CB Our Policy Feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_OurPolicy_FeelFly());

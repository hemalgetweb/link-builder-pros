 ...
 * @since 1.0.0
 */
class CB_Core_HowWeWork_AboutUS_FeelFly extends Widget_Base
{
	...
	{
		return 'cb-howwework-aboutus-feelfly';
	}
	...
	{
		return __('CB How We Work AboutUs Feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_HowWeWork_AboutUS_FeelFly());

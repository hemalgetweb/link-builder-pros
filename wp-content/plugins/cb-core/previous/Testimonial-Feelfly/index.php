 ...
 * @since 1.0.0
 */
class CB_Core_Testimonial_FeelFly extends Widget_Base
{
	...
	{
		return 'cb-best-testimonial-feelfly';
	}
	...
	{
		return __('CB Testimonial Feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_Testimonial_FeelFly());

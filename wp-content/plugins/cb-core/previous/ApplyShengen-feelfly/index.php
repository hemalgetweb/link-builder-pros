 ...
 * @since 1.0.0
 */
class CB_Core_ApplyShengen_FeelFly extends Widget_Base
{
	...
	{
		return 'cb-apply-shengen-feelfly';
	}
	...
	{
		return __('CB ApplyShengen Feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_ApplyShengen_FeelFly());

 ...
 * @since 1.0.0
 */
class CB_Core_FAQ_Breadcome_FeelFly extends Widget_Base
{
	...
	{
		return 'cb-faq-breadcome-feelfly';
	}
	...
	{
		return __('CB FAQ Breadcome Feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_FAQ_Breadcome_FeelFly());

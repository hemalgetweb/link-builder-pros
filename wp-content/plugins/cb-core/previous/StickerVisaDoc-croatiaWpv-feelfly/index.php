 ...
 * @since 1.0.0
 */
class CB_Core_StickerVisaDoc_CroatiaWpv_FeelFly extends Widget_Base
{
	...
	{
		return 'cb-stickervisadoc-croatiawpv-feelfly';
	}
	...
	{
		return __('CB Sticker Visa Doc Croatia WPV Feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_StickerVisaDoc_CroatiaWpv_FeelFly());

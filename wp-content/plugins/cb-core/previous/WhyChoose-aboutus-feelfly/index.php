 ...
 * @since 1.0.0
 */
class CB_Core_WhyChoose_AboutUS_FeelFly extends Widget_Base
{
	...
	{
		return 'cb-whychoose-aboutus-feelfly';
	}
	...
	{
		return __('CB Our Why Choose AboutUs Feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_WhyChoose_AboutUS_FeelFly());

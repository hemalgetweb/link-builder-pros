 ...
 * @since 1.0.0
 */
class CB_Core_Breadcome_AboutUS_FeelFly extends Widget_Base
{
	...
	{
		return 'cb-breadcome-aboutus-feelfly';
	}
	...
	{
		return __('CB Breadcome AboutUs Feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_Breadcome_AboutUS_FeelFly());

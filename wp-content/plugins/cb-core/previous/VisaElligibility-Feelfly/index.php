 ...
 * @since 1.0.0
 */
class CB_Core_VisaElligibility_FeelFly extends Widget_Base
{
	...
	{
		return 'cb-visa-elligibility-feelfly';
	}
	...
	{
		return __('CB VisaEilligibility Feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_VisaElligibility_FeelFly());

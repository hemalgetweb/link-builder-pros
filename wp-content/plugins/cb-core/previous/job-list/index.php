 ...
 * @since 1.0.0
 */
class CB_Core_Job_List extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
			...
			[
				...
				'options' => apps_drop_cat('jobs_category','job'),
				'multiple' => true,
				'label_block' => true,
				'condition' => [
					'query_type' => 'category',
...
Plugin::instance()->widgets_manager->register(new CB_Core_Job_List());

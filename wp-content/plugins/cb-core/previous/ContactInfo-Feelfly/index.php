 ...
 * @since 1.0.0
 */
class CB_Core_ContactInfo_FeelFly extends Widget_Base
{
	...
	{
		return __('CB ContactInfo Feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_ContactInfo_FeelFly());

 ...
 * @since 1.0.0
 */
class CB_Core_FAQ_Section_FeelFly extends Widget_Base
{
	...
	{
		return 'cb-faqsection-faq-feelfly';
	}
	...
	{
		return __('CB FAQ Section FAQ Feelfly', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_FAQ_Section_FeelFly());

...
?>
<div class="ayaa-fz-admin-box-778 <?php echo esc_attr($content_bottom_margin); ?>">
    <div class="ayaa-fz-admin-box-inner-wrapper-774">
        ...
        <?php endif; ?>
        <div class="content">
            <div class="ayaa-fz-admin-box-name-des-wrapper-778">
                <?php if(!empty($author_name)) : ?>
                    <h6 class="ayaa-fz-admin-box-title-778"><?php echo esc_html($author_name); ?></h6>
                <?php endif; ?>
                <?php if(!empty($user_role)) : ?>
                    <span class="ayaa-fz-admin-box-rule-778"><?php echo esc_html($user_role); ?></span>
                <?php endif; ?>
            </div>

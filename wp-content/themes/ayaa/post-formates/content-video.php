...
$ayaa_video_url = function_exists('get_field') ? get_field('fromate_style') : NULL;
$categories = get_the_terms($post->ID, 'category');
$video_id = ayaa_getYoutubeIdFromUrl($ayaa_video_url);

?>

<article id="post-<?php the_ID(); ?>" <?php post_class('ayaa-fz-blog-box-447 mb-50 format-video'); ?>>
    <?php if ((function_exists('has_post_thumbnail')) && (has_post_thumbnail())) : ?>
        <div class="ayaa-fz-blog-thumbnail-447">
            <?php
            ...
            ?>
            <div class="ayaa-fz-thumbnail-image">
                <img src="<?php echo esc_url($image_src); ?>" alt="<?php the_title_attribute(); ?>">
                <?php if (!empty($ayaa_video_url)) : ?>
                    <div class="ayaa-fz-format-video-btn-447">

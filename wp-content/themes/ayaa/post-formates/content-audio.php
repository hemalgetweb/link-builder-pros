<?php
$ayaa_audio_url = function_exists('get_field') ? get_field('fromate_style') : NULL;
...
?>
<article id="post-<?php the_ID(); ?>" <?php post_class('ayaa-fz-blog-box-447 mb-40 format-audio'); ?>>
    <?php if (!empty($ayaa_audio_url)) : ?>
        <div class="postbox__audio embed-responsive embed-responsive-16by9 ayaa-fz-thumbnail-image ayaa-fz-blog-thumbnail-447">
            <?php echo wp_oembed_get($ayaa_audio_url); ?>
    ...
    <div class="ayaa-fz-blog-content-447">
        ...
        <?php endif; ?>
        <div class="ayaa-fz-blog-excerpt-sm-content-447">
            <?php
        ...
        <?php if (!empty($cbtoolkit_blog_btn_switch)) : ?>
            <?php if (!empty($cbtoolkit_blog_btn_text)) : ?>
                <div class="ayaa-fz-blog-btn-wrapper-447 pt-30">

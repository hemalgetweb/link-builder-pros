...
?>
<article id="post-<?php the_ID(); ?>" <?php post_class('ayaa-fz-blog-box-447 format-search mb-50'); ?>>
    <?php if ((function_exists('has_post_thumbnail')) && (has_post_thumbnail())) : ?>
        <div class="ayaa-fz-blog-thumbnail-447">
            ...
            ?>
            <div class="ayaa-fz-thumbnail-image"><img src="<?php echo esc_url($image_src); ?>" alt="<?php the_title_attribute(); ?>"></div>

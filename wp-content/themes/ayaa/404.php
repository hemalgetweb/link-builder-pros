...
$cbtoolkit_error_title = get_theme_mod('cbtoolkit_error_title', __('Page not found', 'ayaa'));
$cbtoolkit_error_desc = get_theme_mod('cbtoolkit_error_desc', __('Oops! The page you are looking for does not exist. It might have been moved or deleted', 'ayaa'));
$cbtoolkit_error_link_text = get_theme_mod('cbtoolkit_error_link_text', __('Back To Home', 'ayaa'));
?>
         ...
         <div class="col-xxl-8 offset-xxl-2 col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
            <div class="error__item text-center">
               ...
               <div class="error__thumb mb-45">
                  <img src="<?php echo esc_url($cbtoolkit_error_404_image); ?>" alt="<?php echo esc_attr__('Error image', 'ayaa'); ?>">
               </div>
               <?php endif; ?>
